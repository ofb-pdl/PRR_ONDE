...
### **Évolution des conditions d'écoulement lors des campagnes usuelles pour le mois en cours (stations toujours actives)** {.tabset}

<br>

#### Typologie nationale
```{r bilan mois national, fig.height = 5.5, fig.width = 9, align = "center", warning = FALSE}
bilan_mois_reg_typo_nat
```

#### Typologie départementale
```{r bilan mois departemental, fig.height = 5.5, fig.width = 9, align = "center", warning = FALSE}
bilan_mois_reg_typo_dep
```

### **Sévérité des assecs (stations toujours actives)**
...
for (d in conf_dep) {
  if (d %in% df_categ_obs_4mod$code_departement) {
    ...
    cat("\n#### **Évolution des conditions d'écoulement lors des campagnes usuelles pour le mois en cours (stations toujours actives)**\n")
    
    print(bilan_mois_dep[[d]])
