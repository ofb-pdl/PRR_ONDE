...
Seules les observations des stations encore actives ont été prises en compte. En Sarthe, le réseau de stations a été modifié en 2017. 7 stations suivies depuis 2012 sont toujours suivies aujourd'hui. 25 stations ne sont plus suivies et ont remplacées par des nouvelles stations en 2017. Cela explique qu'il y ait des données manquantes pour le département.
