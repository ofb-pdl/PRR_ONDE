...
### **Évolution des conditions d'écoulements lors des campagnes usuelles pour le mois en cours (stations encore actives)** {.tabset}
...
for (d in conf_dep) {
  if (d %in% df_categ_obs_4mod$code_departement) {
    ...
    cat("\n#### **Évolution des conditions d'écoulement lors des campagnes usuelles pour le mois en cours (stations encore actives)**\n")
